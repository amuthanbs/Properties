...
namespace EnManaiWebApi.DAO
{
    ...
    public class HouseOwnerDAO : IHouseOwnerDAO
    {
        ...
        //            {
        //                db.Open();
        //                holist = db.Execute(@"UPDATE HOUSEOWNER SET name = @name, lastname=@lastName, fatherName=@fathername, motherName = @motherName, aadharno=@aadharno, phonePrimary=@phonePrimary where id = @id", dic).AsList();
        //            }
        //        }
        //        catch (Exception ex)
        //        {
        ...
        //                            @Pincode,
        //                            @ResidingAddress)";
        //                //holist = db.Query<HouseOwner>(@"SELECT * FROM HOUSEOWNER",dic).AsList();
        //            }
        //        }
        //        catch (Exception ex)
        //        {
