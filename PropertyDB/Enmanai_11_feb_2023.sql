USE [EnManai]
GO
/****** Object:  User [DESKTOP-L1PFAQD\Amuthan]    Script Date: 11-02-2023 23:01:10 ******/
CREATE USER [DESKTOP-L1PFAQD\Amuthan] FOR LOGIN [DESKTOP-L1PFAQD\Amuthan] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  User [NT AUTHORITY\SYSTEM]    Script Date: 11-02-2023 23:01:10 ******/
...
GO
/****** Object:  Table [dbo].[HouseOwner]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[HouseOwnerResidingAddress]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Login]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PaymentForRent]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PaymentForTenant]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RentalHouseDetails]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RentalsImage]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Scheme]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SMSVerification]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserDisplayFields]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[CREATEMODEL]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[EM_HouseOwner]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[EM_PaymentForRent]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[EM_RentalHouseDetails]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	BEGIN 
		...
		BEGIN
			...
			END
			SET @finalSql = @finalSql + ' order by id desc OFFSET '  + CAST(@start AS varchar) +' ROWS FETCH NEXT '+ CAST(@End AS varchar) +' ROWS ONLY';
			PRINT @finalSql 
...
END
GO
/****** Object:  StoredProcedure [dbo].[EM_Scheme]    Script Date: 11-02-2023 23:01:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
